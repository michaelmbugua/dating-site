    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-4 text-center text-md-left ">
                ...
                <div class="py-0">
                    <h3 class="my-4 text-white">Peeka<span class="mx-2 font-italic text-warning ">Boo</span>
                    </h3>
            ...
            <div class="col-md-4 text-white text-center text-md-left ">
                <div class="py-2 my-4">
                    <div>
                        ...
                        Main Campus Off Thika Road-Ruiru P.O Box 2768 – 00200, Nairobi, Kenya</p>
                    </div>

                    <div>
                        <p><i class="fa fa-phone  mx-2 "></i>0748-692-233</p>
                    </div>
                    <div>
                        <p><i class="fa fa-envelope  mx-2"></i><a href="mailto:michaelikagiri@gmail.com">peekaBOO</a>
                        </p>
                    </div>
                </div>
            </div>
