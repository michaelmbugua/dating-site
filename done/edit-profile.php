...
if (isset($_SESSION['userId'])) {
    ...
    if (IsVariableIsSetOrEmpty($row)) {
        ...
        $birthDate = $row['birthDate'];
        $birthday = new DateTime(date('Y-m-d', strtotime($birthDate)));
    ...
    if (isset($_POST['Submit'])) {
        ...
        // Bind parameters
        $updateQueryForTablestmt1->bindParam(':email', $email);
        $updateQueryForTablestmt1->bindParam(':firstName', $firstName);
        $updateQueryForTablestmt1->bindParam(':lastName', $lastName);
        $updateQueryForTablestmt1->bindParam(':bio', $bio);
        $updateQueryForTablestmt1->bindParam(':city', $city);
        $updateQueryForTablestmt1->bindParam(':birthDate', $birthDate);
        $updateQueryForTablestmt1->bindParam(':gender', $gender);
        $updateQueryForTablestmt1->bindParam(':notification', $notification);
        $updateQueryForTablestmt1->bindParam(':id', $id);
